...
\code{AM-rw}%
    %\footnote{AM-rw: \url{https://github.com/fabiobosisio/amrw}}
...
\code{AM-diff}%
    %\footnote{AM-diff: \url{https://github.com/fabiobosisio/amdiff}}
    \footnote{AM-diff: \url{https://github.com/<hidden-anonymous>}}
and \code{AM-patch}%
    %\footnote{AM-patch: \url{https://github.com/fabiobosisio/ampatch}}
